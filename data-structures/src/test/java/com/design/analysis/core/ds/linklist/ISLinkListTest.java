...
public class ISLinkListTest {
    ...
    public void deleteNode() {
        ...
        //del last node
        Integer[] b = {1, 2, 3, 4};
        SLNode<Integer> head1 = isl.insertArrSorted(null, b);
        isl.deleteNode(head1.next.next.next);
        isl.printList(head1);
        Assert.assertNull(head1.next.next.next.k);
    }
    ...
    public void insertArrTest() {
        ...
        Assert.assertEquals(3, (int) head.next.next.k);
        Assert.assertEquals(5, (int) head.next.next.next.next.k);

        Integer[] b = {10, 11, 12};
        isl.insertArrLast(lap, b);
        isl.printList(head);
    ...
    public void insertArrSortedTest() {
        ...
        isl.printList(head);
        Assert.assertEquals(0, (int) head.k);
        Assert.assertEquals(2, (int) head.next.next.k);
        Assert.assertEquals(4, (int) head.next.next.next.next.k);
    }
    ...
    public void insertAtPositionTest() {
        ...
        Lap<SLNode<Integer>, SLNode<Integer>> lap = isl.insertArrLast(null, a);
        SLNode<Integer> head = lap.getHead();
        head = isl.insertAtPosition(head, 1, 2);
        Assert.assertEquals(2, (int) head.k);
        head = isl.insertAtPosition(head, 1, 1);
        Assert.assertEquals(1, (int) head.k);
        head = isl.insertAtPosition(head, 4, 4);
       /* isl.insertAtPosition(head, 9, 9);
        isl.insertAtPosition(head, 0, 10);
        isl.insertAtPosition(head, 10, 10);
*/
        System.out.println("\n");
        isl.printList(head);
    }
    ...
    public void deleteFirstKTest() {
        ...
        Assert.assertEquals(10, (int) head.k);
    ...
    public void deleteAllXTest() {
        ...
        // isl.printList(head);
        Assert.assertEquals(0, (int) head.k);
        Assert.assertEquals(0, (int) head.next.k);
        Assert.assertEquals(2, (int) head.next.next.k);
        head = null;
        lap = isl.insertArrLast(null, b);
        // isl.printList(head);
        ...
        // isl.printList(head);
        Assert.assertEquals(1, (int) head.k);
        Assert.assertEquals(3, (int) head.next.k);
        Assert.assertEquals(4, (int) head.next.next.k);
    }
    ...
    public void deleteLastKTest() {
        ...
        Assert.assertEquals(3, (int) head.next.next.next.next.next.k);
        head = isl.deleteLastK(head, 2);
        head = isl.deleteLastK(head, 1);
        head = isl.deleteLastK(head, 10);
        Assert.assertEquals(4, (int) head.k);
    }
    ...
    public void deletePosTest() {
        ...
        Assert.assertEquals(5, (int) head.next.next.k);
    ...
    public void lengthIterativeTest() {
        ...
        Lap<SLNode<Integer>, SLNode<Integer>> lap = isl.insertArrLast(null, a);
        head = lap.getHead();
        Assert.assertEquals(9, isl.lengthIterative(head));
    }
    ...
    public void lengthRecursiveTest() {
        ...
        Assert.assertEquals(9, (int) isl.lengthRecursive(head));
    }
    ...
    public void searchIterativeTest() {
        ...
        Lap<SLNode<Integer>, SLNode<Integer>> lap = isl.insertArrLast(null, a);
        head = lap.getHead();
        Assert.assertEquals(1, (int) isl.searchIterative(head, 1).k);
        Assert.assertEquals(9, (int) isl.searchIterative(head, 9).k);
        Assert.assertEquals(5, (int) isl.searchIterative(head, 5).k);
        Assert.assertNull(isl.searchIterative(head, 10));
    }
    ...
    public void swapNodesTest() {
        ...
        isl.printList(head);
        Assert.assertEquals(8, (int) head.k);
    }
    ...
    public void getNthNodeTest() {
        ...
        Assert.assertEquals(1, (int) isl.getNthNode(head, 1).k);
        Assert.assertEquals(5, (int) isl.getNthNode(head, 5).k);
        Assert.assertEquals(9, (int) isl.getNthNode(head, 9).k);
    }
    ...
    SLNode<Integer> head = isl.swapPairWiseFromHeadRcv(null,lap.getHead());
    isl.printList(head);
    Assert.assertEquals(2,(int)head.k);
    Assert.assertEquals(5,(int)head.next.next.next.next.k);

    Lap<SLNode<Integer>, SLNode<Integer>> lap1 = isl.insertArrLast(null, b);
    SLNode<Integer> head1 = isl.swapPairWiseFromHeadRcv(null,lap1.getHead());
    isl.printList(head1);
    ...
    public void swapPairWiseFromTailRcvTest() {
        ...
        SLNode<Integer> head = isl.swapPairWiseFromTailRcv(null,lap.getHead());
        isl.printList(head);
        Assert.assertEquals(1,(int)head.k);
        Assert.assertEquals(4,(int)head.next.next.next.next.k);

        Lap<SLNode<Integer>, SLNode<Integer>> lap1 = isl.insertArrLast(null, b);
        SLNode<Integer> head1 = isl.swapPairWiseFromTailRcv(null,lap1.getHead());
        isl.printList(head1);
        Assert.assertEquals(2,(int)head1.k);
        Assert.assertEquals(3,(int)head1.next.next.next.k);
    }
