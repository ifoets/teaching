 ...
 *
 */
public class IHash2KeyALTTest {

	public IHash2KeyALT<Integer, Integer, Product> ihk2alt = null;

	@Before
	public void init() {
		ihk2alt = new Hash2KeyALTImpl();
	}

	/* add mass of element in single shot */
	@Test
	public void addArrayTest() {
		ihk2alt.destroyCache();
		...
		ihk2alt.addArray(key1, key2, arr, 10);
		ihk2alt.print();
		// +ve test case
		Assert.assertTrue(ihk2alt.getElement(0, 0, arr[0]).pName == "computer");
		Assert.assertTrue(ihk2alt.getElement(0, 0, arr[1]).pName == "watch");
		Assert.assertTrue(ihk2alt.getElement(1, 0, arr[5]).pName == "computer");
		Assert.assertTrue(ihk2alt.getElement(1, 0, arr[6]).pName == "watch");
		// -ve test case
		Assert.assertTrue(ihk2alt.getElement(3, 1, arr[0]) == null);
		//Assert.assertTrue(ihk2alt.getElement(0, 0, new Product(0, 14, "0.aaple", "System")) == null);
	}
	...
	public void addElementTest() {
		...
		ihk2alt.addElement(0, 1, p1);
		ihk2alt.addElement(1, 1, p2);
		Assert.assertTrue(ihk2alt.getElement(0, 1, p1).pName == "headphone");
		// ihk2alt.print();
		Assert.assertTrue(ihk2alt.getElement(1, 1, p2).pName == "headphone");
		ihk2alt.destroyCache();
	}
	...
	public void deleteElementTest() {
		...
		ihk2alt.addArray(key1, key2, arr, 10);
		ihk2alt.deleteElement(arr[0]);
		ihk2alt.deleteElement(arr[5]);
		// ihk2alt.print();
		Assert.assertTrue(ihk2alt.getElement(0, 0, arr[0]) == null);
		Assert.assertTrue(ihk2alt.getElement(0, 0, arr[1]).pName == "watch");
		Assert.assertTrue(ihk2alt.getElement(1, 0, arr[5]) == null);
		Assert.assertTrue(ihk2alt.getElement(1, 0, arr[6]).pName == "watch");
	...
	public void hashKey1Test() {
		Product p1 = new Product(1, 16, "0.aaple", "headphone");
		Product p2 = new Product(1, 16, "1.lenavo", "headphone");
		Assert.assertTrue(ihk2alt.hashKey1(p1) == 0);
		Assert.assertTrue(ihk2alt.hashKey1(p2) == 1);
	...
	public void hashKey2Test() {
		...
		Assert.assertTrue(ihk2alt.hashKey2(p1) == 4);
		Assert.assertTrue(ihk2alt.hashKey2(p2) == 5);
