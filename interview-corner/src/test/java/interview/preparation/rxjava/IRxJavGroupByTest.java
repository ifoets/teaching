...
import interview.preparation.rxjava.records.Sale;
import interview.preparation.rxjava.records.Student;
...
import interview.preparation.rxjava.records.keys.FlightOperationKey;
import interview.preparation.rxjava.records.keys.ProductStaticsKey;
import interview.preparation.rxjava.records.keys.TransactionKey;
...
public class IRxJavGroupByTest {

    public IRxJavGroupBy irg;

    @Before
    public void init()
    {
        irg = new RxJavaGroupByImpl();
    }
