...
public class IArraySortTest {
    ...
    public void meargeNArrToMNArrTest() {
        ...
        Assert.assertEquals(mnArr[0] , 2);
        Assert.assertEquals(mnArr[mnArr.length - 1] , 14);
    ...
    public void sortByfriquencyTest() {
        ...
        Assert.assertEquals(a[a.length - 1] , 8);
    }
    ...
    public void sumCloseToZeroTest() {
        ...
        Assert.assertEquals(arr[0] , -80);
        Assert.assertEquals(arr[1] , 85);
    ...
    public void unOrderedLenTest() {
        int a[] = {7, 9, 10, 8, 11};
        Assert.assertEquals(ias.unOrderedLen(a) , 3);
    }
    ...
    public void minSwapForSortTest() {
        int a[] = {1, 5, 4, 3, 2};
        Assert.assertEquals(ias.minSwapForSort(a) , 2);
    }
    ...
    public void minLenUnSortedSubArrayTest() {
        ...
        Assert.assertEquals(ias.minLenUnSortedSubArray(a) , 5);
        Assert.assertEquals(ias.minLenUnSortedSubArray(b) , 4);
    }
    ...
    public void possibleTrianglesTest()
    {
        ...
        Assert.assertEquals(ias.possibleTriangles(a).size(),3);
        Assert.assertEquals(ias.possibleTriangles(b).size(),6);
    }
    ...
    public void pairOfXYTest()
    {
        int[] x = { 2, 1, 6 };
        int[] y = { 1, 5 };
        Assert.assertEquals(ias.pairOfXY(x,y),3);
    }
    /* 21. Count all distinct pairs with difference equal to k */
    @Test
    public void countDistinctPairDiffXTest()
    {
        int a[] = {1, 5, 4, 1, 2};
        int k = 0;
        Assert.assertEquals(1,ias.countDistinctPairDiffX(a,k));
        int b[] = {1, 5, 3};
        int l = 2;
        Assert.assertEquals(1,ias.countDistinctPairDiffX(b,l));
    }
    //Count pairs with absolute difference equal to k
    @Test
    public void countDistinctAbsPairDiffXTest()
    {
        int[] arr = {1, 4, 1, 4, 5};
        int k = 3;
        Assert.assertEquals(4,ias.countDistinctAbsPairDiffX(arr,k));
    }
}
